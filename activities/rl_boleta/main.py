...
files_training = ['consolidado_treinamento (01.12 a 06.12).csv']
files_testing = ['consolidado_teste (10.01 a 14.01).csv', 'consolidado_teste (18.01 a 26.01).csv', 'consolidado_teste (21.02 a 11.03).csv', 'consolidado_teste (23.03 a 28.03).csv']
